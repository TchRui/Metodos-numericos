...
from Programa5puntos import Programa_5_puntos
from GUI_Resultados import Resultados

class Gui_5_puntos:
    def procedimiento_cinco_puntos(self):
        gui = Tk()
        ancho_ventana = 425
        alto_ventana = 435
        ...
        lblTitulo = Label(gui, text="Metodo de los 5 puntos", bg="#CCD9CE", font="Times", width="25", height="2")
        ...
        def funciones():
            ...
            a = Programa_5_puntos()
            lista = a.procedimiento_5_puntos(funcion, x, h)
            for i in lista:
                print(i)
            r = Resultados()
            r.mostrar(lista)
