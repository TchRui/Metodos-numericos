...
from ProgramaFalsaPosicion import Programa_falsa_posicion
from GUI_Resultados import Resultados



class Gui_falsa_posicion:
    def GUI(self):
        gui = Tk()
        ancho_ventana = 425
        alto_ventana = 435
        ...
        lblTitulo = Label(gui, text="Metodo de falsa posicion", bg="#CCD9CE", font="Times", width="25", height="2")
        ...
        def funciones():
            ...
            p = Programa_falsa_posicion()
            lista = p.Procedimiento_falsa_posicion(funcion,a,b,tolerancia,iteraciones)
