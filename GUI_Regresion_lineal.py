...
class Gui_regresion_lineal:
    def GUI(self):
        ...
        def agregar_x():
            try:
                valor_agregar_x = int(caja_ingreso_x.get())
                if valor_agregar_x == "":
        ...
        def eliminar_x():
            ...
            numero_eliminar_x = simpledialog.askinteger("Eliminar", "Ingrese el numero a eliminar")
        ...
        def agregar_y():
            try:
                valor_agregar_y = int(caja_ingreso_y.get())
                if valor_agregar_y == "":
                    messagebox.showinfo("Error", "Debe ingresar un valor")
        ...
        def eliminar_y():
            numero_eliminar_y = simpledialog.askinteger("Eliminar", "Ingrese el numero a eliminar")
        ...
        def funciones():
            if len(lista_valores_x) == 0 or len(lista_valores_y) == 0:
                ...
                p.regresion_lineal(lista_valores_x, lista_valores_y)
