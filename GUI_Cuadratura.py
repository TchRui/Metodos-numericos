...
from ProgramaCuadratura import Programa_cuadratura_Gauss

class Gui_Cuadratura:
    def GUI(self):
        gui = Tk()
        ancho_ventana = 425
        alto_ventana = 335
        ...
        lblTitulo = Label(gui, text="Cuadratura de Gauss", bg="#CCD9CE", font="Times", width="25", height="2")
        ...
        def funciones():
            ...
            p = Programa_cuadratura_Gauss()
            lista = p.procedimiento_Cuadratura(funcion, a, b)
